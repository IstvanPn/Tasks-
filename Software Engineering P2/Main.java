...
public class Main {
  ...
  public static void saveProjects() {
    ...
    try {
      FileWriter writer = new FileWriter("C:/Users/Istvan/Dropbox/Istvan Petersen-43173/Introduction to Software Engineering/Task 24/Done/projectData.txt");
      for (Project project : projectList) {
        project.saveToFile();
      }
      writer.close();
  ...
  public static void loadProjects() {
    ...
    try {
      File projectData = new File("C:/Users/Istvan/Dropbox/Istvan Petersen-43173/Introduction to Software Engineering/Task 24/Done/projectData.txt");
