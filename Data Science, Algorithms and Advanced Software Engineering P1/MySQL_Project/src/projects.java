 ...
 * <p>
 * @author Istvan Petersen
 */
public class projects extends Inputchecks {
	/**
	 ...
	 * database to update project information. The 'Menu' class calls on this method when the user chooses to add 
	...
	public void viewIncomplete(Statement statement) throws SQLException {
		...
		while (results3.next()) {
			System.out.println( 
	                ...
	                + "\nAmount charged: \tR" + results3.getFloat("total_fee") 
	                + "\nAmount Paid: \t" + results3.getFloat("amount_paid")  
	                + "\nProject deadline: \t" + results3.getString("deadline") 
	                + "\nProject finalised: \t" + results3.getString("finalise") 
	                + "\nDate completed: " + results3.getString("comp_date") 
	                + "\n"
					);
		}
	}
			...
			if (d1.compareTo(d2) < 0) {
				...
				while (results5.next()) {
		    		System.out.println(
			                ...
			                + "\nBuilding Type: \t" + results5.getString("build_type")        
			                + "\nPhysical Address: " + results5.getString("address") 
			                + "\nERF Number: \t" + results5.getString("erf_num") 
			                + "\nAmount charged: \tR" + results5.getFloat("total_fee") 
			                + "\nAmount Paid: \t" + results5.getFloat("amount_paid")  
			                + "\nProject deadline: \t" + results5.getString("deadline") 
			                + "\nProject finalised: \t" + results5.getString("finalise") 
			                + "\nDate completed: " + results5.getString("comp_date") 
			                + "\n"
		            );
				}	
		...
		if (search_Choice == 1) {
			...
			while (results6.next()) {
	    		System.out.println(
		                ...
		                + "\nAmount charged: \tR" + results6.getFloat("total_fee") 
		                + "\nAmount Paid: \t" + results6.getFloat("amount_paid")  
		                + "\nProject deadline: \t" + results6.getString("deadline") 
		                + "\nProject finalised: \t" + results6.getString("finalise") 
		                + "\nDate completed: " + results6.getString("comp_date") 
		                + "\n"
	            );
			}
		/* If the user selects option 2, they are prompted to enter the project name. 
		 * Once entered, the program selects all info related to that project to display to the user.
		 */
			...
			while (results7.next()) {
	    		System.out.println(
		                ...
		                + "\nAmount charged: \tR" + results7.getFloat("total_fee") 
		                + "\nAmount Paid: \t" + results7.getFloat("amount_paid")  
		                + "\nProject deadline: \t" + results7.getString("deadline") 
		                + "\nProject finalised: \t" + results7.getString("finalise") 
		                + "\nDate completed: " + results7.getString("comp_date") 
		                + "\n"
	            );
			}
		}
	...
	public void printAllFromTable(Statement statement) throws SQLException{
    	...
    	while (results.next()) {
    		System.out.println(
	                ...
	                + "\nAmount charged: \tR" + results.getFloat("total_fee") 
	                + "\nAmount Paid: \t" + results.getFloat("amount_paid")  
	                + "\nProject deadline: \t" + results.getString("deadline") 
	                + "\nProject finalised: \t" + results.getString("finalise") 
	                + "\nDate completed: " + results.getString("comp_date") 
	                + "\n"
            );
    }
}
