...
public class Project {
  ...
  public void setAmountPaid() {
    ...
    while ((amountPaid > (amountCharged)) || (amountPaid < 0)) {
      ...
      if (amountPaid < 0) {
        System.out.println("Amount cannot be less than 0. Please try again");
        amountPaid = getAmount();
        //else amount paid is more than charged. show suitable error
      } else {
      System.out.println("invalid entry. Please retry");
      System.out.println("Amount paid cannot be more than what has been charged. Please try again");
      amountPaid = getAmount();
      }
    } 
  ...
  public void finaliseProject() {
    ...
    try {
      ...
      FileWriter writer = new FileWriter("C:/Users/Istvan/Dropbox/Istvan Petersen-43173/Introduction to Software Engineering/Task 24/Done/projectComp.txt", true);
  ...
  public void saveToFile() {
    try {
      ...
      FileWriter writer = new FileWriter("C:/Users/Istvan/Dropbox/Istvan Petersen-43173/Introduction to Software Engineering/Task 24/Done/projectInfo.txt", true);
