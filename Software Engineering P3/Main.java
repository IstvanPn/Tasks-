...
/**
 * This class implements a project management system for a
 * structural engineering firm called "Poised"
 * @author Istvan
 * @version 1.0
 */
public class Main {
  ...
  public static void createProject() {
    ...
    //the set methods with no arguments have self contained logic to retrieve the required values
  ...
  public static void saveProjects() {
    ...
    try {
      FileWriter writer = new FileWriter("C:/Users/Istvan/Dropbox/Istvan Petersen-43173/Introduction to Software Engineering/Task 24/Done/projectInfo.txt");
      for (Project project : projectList) {
        project.saveToFile();
      }
      writer.close();
  ...
  public static void loadProjects() {
    ...
    try {
      File projectData = new File("C:/Users/Istvan/Dropbox/Istvan Petersen-43173/Introduction to Software Engineering/Task 24/Done/projectInfo.txt");
  ...
  public static void main(String[] args) {
    ...
    //Welcome screen.
    System.out.println("Welcome to Poised Engineering Ltd.\n==============");
